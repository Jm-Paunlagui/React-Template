...
export default function SystemTab({ hook }) {
    ...
    return (
        <div className="mt-6 space-y-4">
            ...
            {gcCollections > 0 && (
                <Card className={`h-full bg-(--bg-surface) dark:bg-(--bg-surface-2) border border-(--color-card-surface-border) dark:border-white/10 rounded-2xl ${ANIMATE_ENTER_UP} ${staggerDelay(4)}`}>
